...
export const updateProfile = (data) => async (dispatch) => {
  ...
  try {
    const response = await axios.put(
      "https://job-portal-backend-deployment-1sgu.onrender.com/api/v1/user/update/profile",
      data,
      {
...
export const updatePassword = (data) => async (dispatch) => {
    ...
    try {
      const response = await axios.put(
        "https://job-portal-backend-deployment-1sgu.onrender.com/api/v1/user/update/password",
        data,
        {
          withCredentials: true,
